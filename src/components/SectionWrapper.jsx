  ...
  return (
    ...
    ${banner}`}>
        <div className={`flex items-center
         ${reverse ? styles.boxReverseClass : styles.boxClass} w-11/12 sm:2-full minmd: w-3/4`}>
            ...
            `}>
                ...
                {showBtn && (
                    <Button
                        ...
                        link="https://expo.dev/@xxmarvinxx2019/react_nft_project?serviceType=classic&distribution=expo-go"
                    />
                )}
            </div>
